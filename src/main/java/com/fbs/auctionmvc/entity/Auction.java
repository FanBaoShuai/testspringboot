package com.fbs.auctionmvc.entity;
...
public class Auction {
	...
	public Auction(int auction_id, String auction_name,
			Double auction_start_price, int auction_upset,
	...
	public Auction(String auction_name, Double auction_start_price,
			int auction_upset, Date auction_start_time, Date auction_end_time,
	...
	public int getAuction_upset() {
		return auction_upset;
	}
	public void setAuction_upset(int auction_upset) {
		this.auction_upset = auction_upset;
	}
